							...
							<form className="contact-bx">
								<div className="row placeani">
									...
									<div className="col-lg-12">
										...
										<Link className="btn flex-fill m-r10 facebook" style={{color:'white', border : 'none'}}  to="#"><i className="fa fa-facebook"></i>Facebook</Link>
										<Link className="btn flex-fill m-l5 google-plus" style={{color:'white', border : 'none'}} to="#"><i className="fa fa-google-plus"></i>Google Plus</Link>
									</div>
								</div>
							</form>
						</div>
