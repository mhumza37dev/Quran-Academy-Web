                  ...
                  <div className="col-lg-8 col-xl-8">
                    <div className="recent-news blog-lg">
                      ...
                      <div className="info-bx">
                        ...
                        <p>
                          It is used every day in all types of businesses; Email
                          newsletters, websites, print and online
                          advertisements, presentations, social media updates,
                          flyers, and brochures; the list goes on and on
                        </p>
                        <p>
                          David Ogilvy, the advertising legend once said that,
                          ...
                          dollar." As Ogilvy points out, your headline is the
                          first (and sometimes the only) thing that your
                          audience will read.
                        </p>
                        <p>
                        ...
                        <p>
                          ...
                          creating content that their readers crave, but even
                          the best struggle with delivering content to the right
                                    ...
                                    <li className="comment odd parent">
                                      <div className="comment-body">
                                        ...
                                        <p>
                                          ...
                                          consectetur adipiscing elit. Nam vitae
                                          neque vitae sapien malesuada aliquet.
                                          In viverra dictum justo in vehicula.
                                          Fusce et massa eu ante ornare
                                          molestie. Sed vestibulum sem felis, ac
